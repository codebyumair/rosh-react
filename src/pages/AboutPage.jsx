        ...
        <div className="h-screen bg-primary bg-opacity-[.88] md:pt-40 pt-24 w-full founders md:px-16">
          ...
          <div className="px-3">
            ...
            >
              ...
              />
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                Abdullah Khandwani, a creator at heart, is an eminent and
                renowned stained-glass artist from India. He has been
                instrumental in popularizing the art and craft across India and
                Canada over the past three decades.
              </p>
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                Abdullah Khandwani's innovative approach to glass art reflects a
                deep connection to heritage while pushing the boundaries of
                modern artistic expression, making him a true pioneer in the
          ...
          <div className="px-3">
            ...
            >
              ...
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                ...
                creative disciplines. His brilliance shines not only in
                literature but also in the visual arts, where he has earned
                widespread acclaim as a painter. Over the years, he has held 16
                prestigious exhibitions, both in India and internationally,
                captivating audiences with his distinctive artistic vision.
              </p>
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                Early in his career, Surti pioneered a groundbreaking technique
                known as 'mirror collage,' a form of art that caught the
                attention of global critics, earning particular praise in Japan
              ...
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                ...
                Surti's talents extend beyond the canvas. As a gifted
                cartoonist, he brought to life 'Dabbuji,' the beloved simpleton
                whose witty and endearing antics resonated with countless
                readers. Aabid Surti continues to make a mark with his boundless
                creativity and his ability to move seamlessly between artistic
                forms.
              </p>
        ...
        <div className="h-screen bg-primary bg-opacity-[.88] md:pt-40 pt-24 w-full founders md:px-16">
          ...
          <div className="px-3">
            ...
            >
              ...
              />
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                Roshan Ali Khan is a celebrated stained-glass artist with over
                25 years of experience in crafting and captivating large-scale
                murals. Her passion for the art form is showcased through her
                Mumbai-based studio, a hub of creativity and craftsmanship, and
                a showcase of her immense talent.
              </p>
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
                Khan's passion for stained glass work was ignited by two
                influential mentors she met after her studies: the renowned
                artist Abdullah Khandwani and the versatile creative genius
                Aabid Surti, an acclaimed painter, writer, and cartoonist.
              </p>
              <p className="my-2 md:my-0 text-lg md:text-xl font-ebGroundRegular leading-[1.3rem]">
